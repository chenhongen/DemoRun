!function(e, t, s) {
    ...
    !e.DUOSHUO) {
        for (var l in Object.prototype) return Confirm.show('Tips',"Object.prototype 不为空，请不要给 Object.prototype 设置方法");
        var c, u, p = e.JSON,
        h = e.location,
        f = e.XMLHttpRequest,
        ...
        q = function() {
            if (!c && (c = e.duoshuoQuery)) {
                ...
                void Confirm.show('Tips',"你还没有设置多说域名(duoshuoQuery.short_name)，填入已有域名或创建新站点：http://duoshuo.com/create-site/");
        ...
        function() {
            ...
            function x(e, t, s, a) {
                function i() {
                    ...
                    return a || l.find("[type=checkbox]:checked")[0] ? (R.post("posts/repost", S.toJSON(l), e), o.close(), !1) : (Confirm.show('Tips', "还没有选发布到哪儿呢"), !1)
                }
                function r() {
                    var e = this.value;
            ...
            st.Replybox.prototype = {
                render: function(e) {
                    ...
                    T = function(e, t) {
                        ...
                        if (a.find(".ds-icons-32 a").click(l), !c.deny_anonymous) {
                            ...
                            i.submit(function() {
                                ...
                                return ! e && !c.require_guest_email || e.match(/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/) ? (t(S.toJSON(i)), s.close(), !1) : (Confirm.show('Tips',"请输入一个有效的email地址."), !1)
                            }),
                    ...
                    var q = function(e) {
                        ...
                        function(e) {
                            a(b),
                            Confirm.show('Tips',e.errorMessage)
                        })
                    };
                    b.submit(function() {
                        if (b.data("submitting")) return ! 1;
                        var e = H.trim(b[0].message.value);
                        return "" == e || !P.placeholder && e == k.attr("placeholder") ? (Confirm.show('Tips',"您还没写内容呢"), !1) : (r() ? T(b, q) : q(), !1)
                    });
                    var C = function(e) {
            ...
            st.EmbedThread = Q.extend({
                ...
                render: function() {
                    var e = this.el;
                    if ("请将此处替换成文章在你的站点中的ID" === e.data("thread-key")) return Confirm.show('Tips',"请设置正确的 data-thread-key 属性"),
                    !1;
            ...
            st.ShareWidget = Q.extend({
                ...
                delegateEvents: function() {
                    ...
                    function(t) {
                        ...
                        if (!i.data("url")) return void Confirm.show('Tips',"请设置data-url");
                        if ("wechat" === s) {
